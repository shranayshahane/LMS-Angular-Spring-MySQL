...
@Component({
  selector: 'app-edit-pdf-material',
  templateUrl: './edit-pdf-material.component.html',
  styleUrls: ['./edit-pdf-material.component.scss']
})
export class EditPdfMaterialComponent {
